...
treesitter.setupHighlighting = function()
  ...
  highlight(0, '@text.warning',          { fg = colors.blue,      bg = colors.red })
  ...
  highlight(0, '@lsp.type.namespace',                { fg = colors.blue,      bg = "NONE"                 })
  highlight(0, '@lsp.type.number',                { fg = colors.greenLight,      bg = "NONE"                 })
  highlight(0, '@lsp.type.operator',                { fg = colors.white,      bg = "NONE"                 })
  highlight(0, '@lsp.type.parameter',                { fg = colors.blue,      bg = colors.orange                 })
  highlight(0, '@lsp.type.property',                { fg = colors.purple,      bg = "NONE"                 })
  highlight(0, '@lsp.type.regexp',                { fg = colors.blue,      bg = colors.orange                 })
  highlight(0, '@lsp.type.string',                { fg = colors.redLight,      bg = "NONE"                 })
  ...
  highlight(0, '@lsp.type.variable',                { fg = colors.purple,      bg = "NONE"                 })
