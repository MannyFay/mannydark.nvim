...
render_markdown.setupHighlighting = function()
  ...
  highlight(0, "RenderMarkdownH1", { fg = colors.blue, bold = true })
  highlight(0, "RenderMarkdownH2", { fg = colors.turquoise, bold = true })
  highlight(0, "RenderMarkdownH3", { fg = colors.green, bold = true })
  highlight(0, "RenderMarkdownH4", { fg = colors.orange, bold = true })
  highlight(0, "RenderMarkdownH5", { fg = colors.purple, bold = true })
  highlight(0, "RenderMarkdownH6", { fg = colors.pink, bold = true })
