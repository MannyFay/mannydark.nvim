...
nvimCmp.setupHighlighting = function()
  ...
  highlight(0, 'CmpItemKindEnumMember',    { fg = colors.green,     bg = 'NONE'                            })  -- Enum member kind marker text.
  highlight(0, 'CmpItemKindTypeParameter', { fg = colors.turquoise, bg = 'NONE'                           })  -- Type parameter kind marker text.
