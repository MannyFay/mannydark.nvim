...
nvimCmp.setupHighlighting = function()
  ...
  highlight(0, 'CmpItemKindField',         { fg = colors.green, bg = colors.purple                         })
  highlight(0, 'CmpItemKindProperty',      { fg = colors.pink, bg = colors.blue                            })
  ...
  highlight(0, 'CmpItemKindUnit',          { fg = colors.pink, bg = colors.purple                          })
  highlight(0, 'CmpItemKindFile',          { fg = colors.blue, bg = colors.redLight                        })
  highlight(0, 'CmpItemKindFolder',        { fg = colors.blue, bg = colors.green                           })
