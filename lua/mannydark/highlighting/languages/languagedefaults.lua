...
languageDefaults.setupHighlighting = function()
  ...
  highlight(0, "Error",          { link = "MannydarkFgRed", underline = true }     )  -- Errors
  ...
  highlight(0, "Macro",          { link = "Function" }                 )  -- Macros
...
languageDefaults.applyLspSemanticHighlights = function()
  ...
  highlight(0, "@lsp.type.class",         { link = "Type"})  -- Class types
  ...
  highlight(0, "@lsp.type.regexp",        { link = "Function"}   )  -- Regexes
  highlight(0, "@lsp.type.string",        { link = "String" }                   )  -- Strings
  highlight(0, "@lsp.type.struct",        { link = "Type"})  -- Structs
  highlight(0, "@lsp.type.type",          { link = "Type"})  -- Types
  ...
  -- Characters
  highlight(0, "@character",                   { link = "String"})  -- Character literals
  ...
  highlight(0, "@type.qualifier",              { link = "Keyword"})  -- Type qualifiers (const)
  ...
  -- Properties
  highlight(0, "@property",                    { link = "Variable" })  -- Object properties
  ...
  -- Constructors
  highlight(0, "@constructor",                 { link = "Function"})  -- Constructors
  ...
  highlight(0, "@keyword.directive.define",    { link = "Keyword" })  -- #define
  highlight(0, "@keyword.conditional.ternary", { link = "Delimiter"})  -- ? :
  ...
  highlight(0, "@comment.warning",             { link = "Warning" })  -- WARNING, HACK
  ...
  highlight(0, "@markup.list",                 { link = "Delimiter" })  -- List markers
  highlight(0, "@markup.list.checked",         { link = "Delimiter" })  -- [x] checked
  ...
  highlight(0, "DiagnosticError",              { link = "Error"})  -- Errors
  highlight(0, "DiagnosticWarn",               { link = "Warning" })  -- Warnings
  ...
  -- Virtual text (with underline for visibility)
  highlight(0, "DiagnosticVirtualTextError",   { fg = colors.red,        bg = "NONE", underline = true })
  highlight(0, "DiagnosticVirtualTextWarn",    { fg = colors.orange,     bg = "NONE", underline = true })
  highlight(0, "DiagnosticVirtualTextInfo",    { fg = colors.blue,       bg = "NONE", underline = true })
  highlight(0, "DiagnosticVirtualTextHint",    { fg = colors.turquoise,  bg = "NONE", underline = true })
  highlight(0, "DiagnosticVirtualTextOk",      { fg = colors.green,      bg = "NONE", underline = true })

  -- Underline for diagnostic source in code (text color + underline)
  highlight(0, "DiagnosticUnderlineError",     { fg = colors.red,        bg = "NONE", underline = true })
  highlight(0, "DiagnosticUnderlineWarn",      { fg = colors.orange,     bg = "NONE", underline = true })
  highlight(0, "DiagnosticUnderlineInfo",      { fg = colors.blue,       bg = "NONE", underline = true })
  highlight(0, "DiagnosticUnderlineHint",      { fg = colors.turquoise,  bg = "NONE", underline = true })
  highlight(0, "DiagnosticUnderlineOk",        { fg = colors.green,      bg = "NONE", underline = true })

  -- Floating windows
  highlight(0, "DiagnosticFloatingError",      { link = "Error" })
  highlight(0, "DiagnosticFloatingWarn",       { link = "Warning" })
  ...
  highlight(0, "DiagnosticSignWarn",           { link = "Warning" })
  ...
  highlight(0, "DiagnosticUnnecessary",        { fg = colors.turquoise,  bg = "NONE", underline = true })
  ...
  highlight(0, "SpellCap",                     { fg = "NONE",            bg = "NONE", undercurl = true, sp = colors.orange })
  ...
  highlight(0, "@text.warning",                { link = "Warning" })
