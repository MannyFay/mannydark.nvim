...
clojure.setupHighlighting = function()
  ...
  highlight(0, 'clojureVar',            { link = "Variable" })  -- var
  ...
  -- Functions
  highlight(0, 'clojureFunction',       { link = "Function" })  -- Function names
  highlight(0, 'clojureFunctionCall',   { link = "Function" })  -- Function calls
  highlight(0, 'clojureBuiltinFunc',    { link = "Function" })  -- Built-in functions
  highlight(0, 'clojureMacro',          { fg = colors.orange,     bg = 'NONE'            })  -- Macro calls

  -- Core Functions
  highlight(0, 'clojureCoreFunc',       { link = "Function" })  -- map, filter, reduce, etc.
  ...
  -- Types
  highlight(0, 'clojureType',           { link = "Type" })  -- Type names
  ...
  highlight(0, 'clojureVariable',       { link = "Variable" })  -- Variables
  ...
  -- Keywords
  highlight(0, 'clojureKeyword',        { link = "Keyword" })  -- :keyword
  highlight(0, 'clojureKeywordNs',      { link = "Keyword" })  -- ::namespaced-keyword
  highlight(0, 'clojureKeywordColon',   { link = "Keyword" })  -- : prefix

  -- Constants/Literals
  highlight(0, 'clojureConstant',       { link = "Constant" })  -- Constants
  highlight(0, 'clojureBoolean',        { link = "Boolean" })  -- true, false
  highlight(0, 'clojureNil',            { fg = colors.blue,       bg = 'NONE'            })  -- nil
  highlight(0, 'clojureSpecialValue',   { fg = colors.blue,       bg = 'NONE'            })  -- ##Inf, ##-Inf, ##NaN

  -- Strings
  highlight(0, 'clojureString',         { link = "String" })  -- "strings"
  highlight(0, 'clojureStringEscape',   { link = "String" })  -- \n, \t, \", \\
  ...
  -- Numbers
  highlight(0, 'clojureNumber',         { link = "Number" })  -- Numbers
  ...
  highlight(0, 'clojureDeref',          { link = "Variable" })  -- @ deref
  ...
  highlight(0, 'clojureVarQuote',       { link = "Variable" })  -- #' var quote
  ...
  -- Java Interop
  highlight(0, 'clojureJavaMethod',     { link = "Function" })  -- .method
  highlight(0, 'clojureJavaStaticMethod', { link = "Function" })  -- Class/method
  highlight(0, 'clojureJavaField',      { fg = colors.purple,     bg = 'NONE'            })  -- .-field

  -- Comments
  highlight(0, 'clojureComment',        { link = "Comment" })  -- ; comments
  highlight(0, 'clojureCommentForm',    { link = "Comment" })  -- (comment ...)
  ...
  -- Variables
  highlight(0, '@variable.clojure',              { link = "Variable" })  -- Variables
  highlight(0, '@variable.builtin.clojure',      { link = "Variable" })  -- &form, &env
  highlight(0, '@variable.parameter.clojure',    { link = "Variable" })  -- Function parameters
  highlight(0, '@variable.member.clojure',       { link = "Variable" })  -- Java fields

  -- Constants
  highlight(0, '@constant.clojure',              { link = "Constant" })  -- Constants
  highlight(0, '@constant.builtin.clojure',      { link = "Constant" })  -- true, false, nil

  -- Functions
  highlight(0, '@function.clojure',              { link = "Function" })  -- Function definitions
  highlight(0, '@function.call.clojure',         { link = "Function" })  -- Function calls
  highlight(0, '@function.builtin.clojure',      { link = "Function" })  -- Built-in functions
  highlight(0, '@function.macro.clojure',        { link = "Function" })  -- Macro calls
  highlight(0, '@function.method.clojure',       { link = "Function" })  -- Java methods
  highlight(0, '@constructor.clojure',           { fg = colors.turquoise, bg = 'NONE' })  -- Type constructors

  -- Types
  highlight(0, '@type.clojure',                  { link = "Type" })  -- Type names
  highlight(0, '@type.builtin.clojure',          { link = "Type" })  -- Built-in types

  -- Modules/Namespaces
  highlight(0, '@module.clojure',                { fg = colors.turquoise, bg = 'NONE' })  -- Namespaces

  -- Keywords
  highlight(0, '@keyword.clojure',               { link = "Keyword" })  -- Special forms
  highlight(0, '@keyword.function.clojure',      { link = "Keyword" })  -- fn, defn, defmacro
  highlight(0, '@keyword.conditional.clojure',   { link = "Conditional" })  -- if, when, cond, case
  highlight(0, '@keyword.repeat.clojure',        { link = "Keyword" })  -- loop, recur, for, doseq
  highlight(0, '@keyword.exception.clojure',     { link = "Keyword" })  -- try, catch, finally, throw
  highlight(0, '@keyword.import.clojure',        { link = "Keyword" })  -- require, import, use
  highlight(0, '@keyword.coroutine.clojure',     { link = "Keyword" })  -- go, async (core.async)
  highlight(0, '@keyword.operator.clojure',      { link = "Operator" })  -- and, or, not

  -- Strings
  highlight(0, '@string.clojure',                { link = "String" })  -- Strings
  highlight(0, '@string.escape.clojure',         { link = "String" })  -- Escape sequences
  highlight(0, '@string.regexp.clojure',         { link = "String" })  -- Regex #"..."
  highlight(0, '@string.special.symbol.clojure', { link = "String" })  -- Keywords :foo

  -- Characters
  highlight(0, '@character.clojure',             { fg = colors.redLight,  bg = 'NONE' })  -- Character literals

  -- Numbers
  highlight(0, '@number.clojure',                { link = "Number" })  -- Numbers
  highlight(0, '@number.float.clojure',          { link = "Number" })  -- Floats

  -- Booleans
  highlight(0, '@boolean.clojure',               { link = "Boolean" })  -- true, false

  -- Comments
  highlight(0, '@comment.clojure',               { link = "Comment" })  -- Comments

  -- Labels (unused but reserved)
  highlight(0, '@label.clojure',                 { fg = colors.pink,      bg = 'NONE' })  -- Labels

  -- Operators and Punctuation
  highlight(0, '@operator.clojure',              { link = "Operator" })  -- Operators
  highlight(0, '@punctuation.bracket.clojure',   { fg = colors.white,     bg = 'NONE' })  -- (), [], {}
  highlight(0, '@punctuation.delimiter.clojure', { link = "Delimiter" })  -- Delimiters
  ...
  highlight(0, '@lsp.type.variable.clojure',      { link = "Variable" })  -- Variables
  ...
  highlight(0, '@lsp.type.keyword.clojure',       { link = "Keyword" })  -- Keywords :foo
  highlight(0, '@lsp.type.string.clojure',        { link = "String" })  -- Strings
  highlight(0, '@lsp.type.number.clojure',        { link = "Number" }) -- Numbers
  highlight(0, '@lsp.type.comment.clojure',       { link = "Comment" })  -- Comments

  -- LSP Modifiers
  highlight(0, '@lsp.typemod.function.definition.clojure',  { fg = colors.orange,    bg = 'NONE' })  -- Function definitions
  highlight(0, '@lsp.typemod.variable.readonly.clojure',    { link = "Variable" })  -- Immutable bindings
  highlight(0, '@lsp.typemod.variable.defaultLibrary.clojure', { link = "Variable" })  -- Core functions
end
