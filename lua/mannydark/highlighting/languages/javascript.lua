...
javaScript.setupHighlighting = function()
  ...
  highlight(0, 'jsFuncArgExpression',             { fg = colors.yellow, bg = colors.blue })
  highlight(0, 'jsRestExpression',                { fg = colors.yellow, bg = colors.blue })
  highlight(0, 'jsFlowArgumentDef',               { fg = colors.yellow, bg = colors.blue })
  highlight(0, 'jsCommentFunction',               { fg = colors.yellow, bg = colors.blue })
  highlight(0, 'jsFlowReturn',                    { fg = colors.yellow, bg = colors.blue })
  highlight(0, 'jsClassMethodType',               { fg = colors.yellow, bg = colors.blue })
