...
shell.setupHighlighting = function()
  ----------------------- Not used by now:
  highlight(0, 'shComment',      { fg = colors.pink, bg = colors.green })
  highlight(0, 'shShebang',      { fg = colors.pink, bg = colors.green })
  highlight(0, 'shOperator',     { fg = colors.pink, bg = colors.green })
  highlight(0, 'shSemicolon',{ fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shStatement',   { fg = colors.pink, bg = colors.green })
  highlight(0, 'bashSpecialVariables',{ fg = colors.pink, bg = colors.green })
  highlight(0, 'shCmdSubRegion',{ fg = colors.pink, bg = colors.green })
  highlight(0, 'shDerefSimple', { fg = colors.pink, bg = colors.green })
  highlight(0, 'shFor',         { fg = colors.pink, bg = colors.green })
  highlight(0, 'shFunctionKey', { fg = colors.pink, bg = colors.green })
  highlight(0, 'shQuote',       { fg = colors.pink, bg = colors.green })
  highlight(0, 'shRange',       { fg = colors.pink, bg = colors.green })
  highlight(0, 'shSnglCase',    { fg = colors.pink, bg = colors.green })
  highlight(0, 'shTestOpr',     { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shDeref',       { fg = colors.pink, bg = colors.green })
  highlight(0, 'shDo',          { fg = colors.pink, bg = colors.green })
  highlight(0, 'shEcho',        { fg = colors.pink, bg = colors.green })
  highlight(0, 'shEscape',      { fg = colors.pink, bg = colors.green })
  highlight(0, 'shNumber',      { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shSingleQuote', { fg = colors.pink, bg = colors.green })
  highlight(0, 'shDoubleQuote', { fg = colors.pink, bg = colors.green })
  highlight(0, 'shVariable',    { fg = colors.pink, bg = colors.green })
  highlight(0, 'shAlias',       { fg = colors.pink, bg = colors.green })
  highlight(0, 'shTest',        { fg = colors.pink, bg = colors.green })
  highlight(0, 'shCtrlSeq',     { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shExpr',        { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shOption',      { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shDerefVar',    { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shDerefVarArray',{ fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shConditional', { fg = colors.pink, bg = colors.green })
  ...
  highlight(0, 'shFunction',    { fg = colors.pink, bg = colors.green })
