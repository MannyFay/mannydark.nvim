...
theme.buildTheme = function()
  ...
  require('mannydark.highlighting.javascript').setupHighlighting()
  require('mannydark.highlighting.languages.languagedefaults').setupHighlighting()
  require('mannydark.highlighting.laravelblade').setupHighlighting()
  ...
  require('mannydark.highlighting.hopplugin').setupHighlighting()
  require('mannydark.highlighting.lualineplugin').setupHighlighting()
